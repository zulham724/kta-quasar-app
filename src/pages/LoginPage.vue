<template>
<div style="height:100vh;background-image:linear-gradient(0deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),url('statics/images/bg-login.jpg');background-size:cover">
        ...
        <div class="row justify-center align-center full-height full-width">
            <div class="col-12">
                <div class="row justify-center" style="text-align:center">
                    <img src="~assets/agpaii-logo-transparent.png" style="height:15vh" />
            ...
            <div class="col-12">
                <q-form @submit="onSubmit" ref="form" class="q-gutter-md">
                    <q-input color="teal" style="opacity:0.8" bg-color="white" rounded outlined label="Email anda" v-model="credential.username" lazy-rules :rules="[
                val => (val && val.length > 0) || 'Harus diisi'
              ]" />
                    <q-input color="teal" style="opacity:0.8" bg-color="white" rounded outlined label="Password" v-model="credential.password"  :type="show_password?'text':'password'" lazy-rules :rules="[
                val => (val && val.length > 0) || 'Harus diisi'
              ]" >
            ...
            <div class="col-12" style="z-index:1">
                <div class="row justify-end">
                    <q-btn label="Masuk" @click="onSubmit()" rounded color="teal" type="submit" :loading="loading" :disable="loading" />
                </div>
            </div>
            <div class="col-12">
