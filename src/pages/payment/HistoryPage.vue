...
<q-layout view="hHh Lpr fFf">
    ...
    <q-page-container>
        <q-banner dense class="bg-red text-white" v-if="
        ...
        <q-banner dense class="bg-teal text-white" v-if="
          moment(new Date()).diff(
            new Date(Auth.auth.user_activated_at),
            'months',
            true
        ...
        <q-list bordered padding class="rounded-borders">
            ...
            <q-item clickable v-ripple v-for="payment in Auth.auth.payments" :key="payment.id">
                <q-item-section>
