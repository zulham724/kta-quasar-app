    ...
    <q-page-container>
        <q-page v-if="post != null">
            <div class="q-pa-md">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-caption" style="overflow-wrap:break-word; white-space:pre-line" v-html="post.body" v-linkified>
                        </div>
                    </div>
                </div>
            ...
            <q-list bordered class="rounded-borders">
                ...
                <item-component v-for="comment in post.comments" :key="comment.id" :comment="comment"></item-component>
            </q-list>
        </q-page>
    </q-page-container>
